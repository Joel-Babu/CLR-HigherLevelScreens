...
public class WeeklyTradingStatementWOWGroupObjects 
{
	...
	public static final String Departments="//td[contains(@id,'form:table1:dynamic:j')][1]"; //Business Units Column
	public static final String TotalTitle="//td[contains(@id,'form:table1:j')][1]";	//WOOLWORTHS GROUP TOTAL Text
...
///Wages
	...
	//public static final String PlannedCPHWagesTtl="//td[contains(@id,'form:table1:j')][16]";
	...
	//public static final String PlannedWagesTtl="//td[contains(@id,'form:table1:j')][17]/span[1]";
	public static final String PlannedWagesPercentageTtl="//td[contains(@id,'form:table1:j')][18]/span[2]";
	//public static final String PlannedWagesPercentageTtl="//td[contains(@id,'form:table1:j')][17]/span[2]";
	...
	//public static final String CPHWagesTtl="//td[contains(@id,'form:table1:j')][18]/span[1]";
	public static final String VarBudgetWagesTtl="//td[contains(@id,'form:table1:j')][19]/span[2]";
	//public static final String VarBudgetWagesTtl="//td[contains(@id,'form:table1:j')][18]/span[2]";
