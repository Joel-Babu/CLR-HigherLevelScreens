...
//Hours
	...
	public static final String LLTitle="//td[contains(@id,'form:table1:16:j_idt274')]";	//Longlife
	public static final String SDTitle="//td[contains(@id,'form:table1:17:j_idt274')]";	//Seafood
	//Sales///
	public static final String ActualSalesLL="//td[contains(@id,'form:table1:16:j_idt279')]";	//Actual salesLonglife
	public static final String ActualSalesSD="//td[contains(@id,'form:table1:17:j_idt279')]";	//Actual sales Seafood
	
	public static final String PlannedSalesLL="//td[contains(@id,'form:table1:16:j_idt282')]/span[1]";	//Planned sales Longlife
	public static final String PlannedSalesSD="//td[contains(@id,'form:table1:17:j_idt282')]/span[1]";	// Planned sales Seafood
	public static final String PlannedSalesGrwthLL="//td[contains(@id,'form:table1:16:j_idt282')]/span[2]";	//켗LAN Longlife
	public static final String PlannedSalesGrwthSD="//td[contains(@id,'form:table1:17:j_idt282')]/span[2]";	//켗LAN Seafood
	public static final String LYSalesLL="//td[contains(@id,'form:table1:16:j_idt288')]/span[1]";	//LAST YR  Longlife
	public static final String LYSalesSD="//td[contains(@id,'form:table1:17:j_idt288')]/span[1]";	//LAST YR  Seafood
	public static final String LYSalesGrwthLL="//td[contains(@id,'form:table1:16:j_idt288')]/span[2]";	//�%L/YR Longlife
	public static final String LYSalesGrwthSD="//td[contains(@id,'form:table1:17:j_idt288')]/span[2]";	//�%L/YR Seafood
	public static final String BudgetSalesLL="//td[contains(@id,'form:table1:16:j_idt294')]/span[1]";	//BUDGET Longlife
	public static final String BudgetSalesSD="//td[contains(@id,'form:table1:17:j_idt294')]/span[1]";	//BUDGET Seafood
	public static final String BudgetSalesGrwthLL="//td[contains(@id,'form:table1:16:j_idt294')]/span[2]";	//켃UD Longlife
	public static final String BudgetSalesGrwthSD="//td[contains(@id,'form:table1:17:j_idt294')]/span[2]";	//켃UD Seafood
	public static final String AvgBasketSalesLL="//td[contains(@id,'form:table1:16:j_idt298')]/span[1]";	//AVG BASKET$ Longlife
	public static final String AvgBasketSalesSD="//td[contains(@id,'form:table1:17:j_idt298')]/span[1]";	//AVG BASKET$ Seafood
	public static final String MixLL="//td[contains(@id,'form:table1:16:j_idt298')]/span[2]";	//MIX Longlife
	public static final String MixSD="//td[contains(@id,'form:table1:17:j_idt298')]/span[2]";	//MIX Seafood
	
	///Items & Item Price/////////////////////////////////////////////////////////////////////////////////////////
	
	public static final String PlannedItemLL="//td[contains(@id,'form:table1:16:j_idt304')]/span[1]";	//ITEM PLAN Longlife
	public static final String PlannedItemSD="//td[contains(@id,'form:table1:17:j_idt304')]/span[1]";	//ITEM PLAN Seafood
	public static final String ActualItemLL="//td[contains(@id,'form:table1:16:j_idt304')]/span[2]";	//ITEM ACTUAL Longlife
	public static final String ActualItemSD="//td[contains(@id,'form:table1:17:j_idt304')]/span[2]";	//ITEM ACTUAL Seafood
	public static final String PlannedItemPriceLL="//td[contains(@id,'form:table1:16:j_idt308')]/span[1]";	//ITEM PRICE PLAN Longlife
	public static final String PlannedItemPriceSD="//td[contains(@id,'form:table1:17:j_idt308')]/span[1]";	//ITEM PRICE PLAN Seafood
	public static final String ActualItemPriceLL="//td[contains(@id,'form:table1:16:j_idt308')]/span[2]";	//ITEM PRICE ACTUAL Longlife
	public static final String ActualItemPriceSD="//td[contains(@id,'form:table1:17:j_idt308')]/span[2]";	//ITEM PRICE ACTUAL Seafood
	
	////////////////Customers/////////////////////////////////////////////////////////////////////////////////
	
	public static final String ThisYrCustomerLL="//td[contains(@id,'form:table1:16:j_idt312')]"; //This year customer Longlife
	public static final String ThisYrCustomerSD="//td[contains(@id,'form:table1:17:j_idt312')]"; //This year customer Seafood
	public static final String PercentageLastCustomerLL="//td[contains(@id,'form:table1:16:j_idt314')]/span[1]"; //LYpercustomer Longlife
	public static final String PercentageLastCustomerSD="//td[contains(@id,'form:table1:17:j_idt314')]/span[1]"; //LYpercustomer Seafood
	...
	/////////////////////////Hours///////////////////////////////////////////////////
	public static final String ActualHoursLL="//td[contains(@id,'form:table1:16:j_idt322')]/span[1]";//ActualHours Longlife
	public static final String ActualHoursSD="//td[contains(@id,'form:table1:17:j_idt322')]/span[1]";//ActualHours Seafood
	public static final String VarSMSHoursLL="//td[contains(@id,'form:table1:16:j_idt322')]/span[2]"; //VarSMSHours Longlife
	public static final String VarSMSHoursSD="//td[contains(@id,'form:table1:17:j_idt322')]/span[2]"; //VarSMSHours Seafood
	public static final String PlannedHoursLL="//td[contains(@id,'form:table1:16:j_idt326')]/span[1]"; //PlannedHours Longlife
	public static final String PlannedHoursSD="//td[contains(@id,'form:table1:17:j_idt326')]/span[1]"; //PlannedHours Seafood
	public static final String VarPlannedHoursLL="//td[contains(@id,'form:table1:16:j_idt326')]/span[2]"; //VarPlanned Longlife
	public static final String VarPlannedHoursSD="//td[contains(@id,'form:table1:17:j_idt326')]/span[2]";//VarPlanned Seafood
	public static final String ActualSMSHoursLL="//td[contains(@id,'form:table1:16:j_idt330')]/span[1]"; //ActualSMSHours Longlife
	public static final String ActualSMSHoursSD="//td[contains(@id,'form:table1:17:j_idt330')]/span[1]"; //ActualSMSHours Seafood
	public static final String ORPercentageHoursLL="//td[contains(@id,'form:table1:16:j_idt330')]/span[2]"; //ORPercentageHours Longlife
	public static final String ORPercentageHoursSD="//td[contains(@id,'form:table1:17:j_idt330')]/span[2]"; //ORPercentageHours Seafood
	
	///////////////////////////////Wages/////////////////////////////////////////////////////////////////////////////////
	public static final String ActualWagesLL="//td[contains(@id,'form:table1:16:j_idt337')]/span[1]";
	public static final String ActualWagesSD="//td[contains(@id,'form:table1:17:j_idt337')]/span[1]";
	public static final String ActualWagesPercentageLL="//td[contains(@id,'form:table1:16:j_idt337')]/span[2]";
	public static final String ActualWagesPercentageSD="//td[contains(@id,'form:table1:17:j_idt337')]/span[2]";
	
	public static final String PlannedWagesLL="//td[contains(@id,'form:table1:16:j_idt343')]/span[1]";
	public static final String PlannedWagesSD="//td[contains(@id,'form:table1:17:j_idt343')]/span[1]";	
	public static final String PlannedWagesPercentageLL="//td[contains(@id,'form:table1:16:j_idt343')]/span[2]";
	public static final String PlannedWagesPercentageSD="//td[contains(@id,'form:table1:17:j_idt343')]/span[2]";
	
	public static final String BudgetWagesLL="//td[contains(@id,'form:table1:16:j_idt349')]/span[1]";
	public static final String BudgetWagesSD="//td[contains(@id,'form:table1:17:j_idt349')]/span[1]";
	public static final String BudgetWagesPercentageLL="//td[contains(@id,'form:table1:16:j_idt349')]/span[2]";
	public static final String BudgetWagesPercentageSD="//td[contains(@id,'form:table1:17:j_idt349')]/span[2]";
	
	
	public static final String AllowedWagesLL="//td[contains(@id,'form:table1:16:j_idt357')]";
	public static final String AllowedWagesSD="//td[contains(@id,'form:table1:17:j_idt357')]";
	
	public static final String PlannedCPHWagesLL="//td[contains(@id,'form:table1:16:j_idt359')]";
	public static final String PlannedCPHWagesSD="//td[contains(@id,'form:table1:17:j_idt359')]";
	
	public static final String CPHWagesLL="//td[contains(@id,'form:table1:16:j_idt375')]";
	public static final String CPHWagesSD="//td[contains(@id,'form:table1:17:j_idt375')]";
	
	public static final String ActualWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt337')]/span[1]";
	public static final String ActualWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt337')]/span[1]";
	public static final String ActualWagesPercentagemtsLL="//td[contains(@id,'form:table1:16:j_idt337')]/span[2]";
	public static final String ActualWagesPercentagemtsSD="//td[contains(@id,'form:table1:17:j_idt337')]/span[2]";
	
	public static final String PlannedWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt361')]/span[1]";
	public static final String PlannedWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt361')]/span[1]";	
	public static final String PlannedWagesPercentagemtsLL="//td[contains(@id,'form:table1:16:j_idt361')]/span[2]";
	public static final String PlannedWagesPercentagemtsSD="//td[contains(@id,'form:table1:17:j_idt361')]/span[2]";
	
	public static final String BudgetWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt349')]/span[1]";
	public static final String BudgetWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt349')]/span[1]";
	public static final String BudgetWagesPercentagemtsLL="//td[contains(@id,'form:table1:16:j_idt349')]/span[2]";
	public static final String BudgetWagesPercentagemtsSD="//td[contains(@id,'form:table1:17:j_idt349')]/span[2]";
	
	
	public static final String AllowedWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt357')]";
	public static final String AllowedWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt357')]";
	
	public static final String PlannedCPHWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt359')]";
	public static final String PlannedCPHWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt359')]";
	
	public static final String CPHWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt367')]/span[1]";
	public static final String CPHWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt367')]/span[1]";
	
	public static final String VarBudgetWagesmtsLL="//td[contains(@id,'form:table1:16:j_idt367')]/span[2]";
	public static final String VarBudgetWagesmtsSD="//td[contains(@id,'form:table1:17:j_idt367')]/span[2]";
