...
public class WeeklyTradingStatementStateObjects 
{
	...
	public static final String Departments="//td[contains(@id,'form:table1:dynamic:j')][1]";	//Zones Column
	public static final String TotalTitle="//td[contains(@id,'form:table1:j')][1]";	//State Total Text
