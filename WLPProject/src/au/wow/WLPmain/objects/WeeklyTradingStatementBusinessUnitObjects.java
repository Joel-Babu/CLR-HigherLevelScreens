...
public class WeeklyTradingStatementBusinessUnitObjects 
{
	...
	public static final String Departments="//td[contains(@id,'form:table1:dynamic:j')][1]";//store column
	public static final String TotalTitle="//td[contains(@id,'form:table1:j')][1]";//business total text
