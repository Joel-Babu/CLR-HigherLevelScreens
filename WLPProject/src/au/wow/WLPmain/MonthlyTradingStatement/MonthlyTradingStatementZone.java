...
public class MonthlyTradingStatementZone extends TestBase {
	protected Logger log = LogManager.getLogger(MonthlyTradingStatementZone.class);
	TestStatus status;
	...
	public MonthlyTradingStatementZone() {
		super.log = log;
	}
	...
	// Sales
	@Test(description = "Monthly Trading Statement - Zone, SalesColumnValidation", priority = 1)
	public void SalesColumnValidation() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToViewMonthlyTrading, "Zone");
		//pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
			//	objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("MTSZone"));
		...
		//htmlToExtent(cName,mName,extentTest,driver, "Planned Sales ;;;INFO");
	...
	@Test(description = "Monthly Trading Statement - Zone, Planned Item", priority = 2)
	...
	// Customers
	@Test(description = "Monthly Trading Statement - Zone, This Year Customer", priority = 3)
	...
	@Test(description = "Monthly Trading Statement - Zone, Growth in SMS Hours", priority = 4)
	...
	// Wages
	@Test(description = "Monthly Trading Statement - Zone, Actual Wages", priority = 5)
	public void WagesColumnValidation() throws Exception {
		...
		ActlWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementZoneObjects.Departments, objWeeklyTradingStatementZoneObjects.ActualWages,
				objWeeklyTradingStatementZoneObjects.DataTable);
		ActlWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(objWeeklyTradingStatementZoneObjects.TotalTitle,
				objWeeklyTradingStatementZoneObjects.ActualWagesTtl);
		...
		ActlWgPrcntVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementZoneObjects.Departments,
				objWeeklyTradingStatementZoneObjects.ActualWagesPercentage,
				objWeeklyTradingStatementZoneObjects.DataTable);
		ActlWgPrcntTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementZoneObjects.TotalTitle,
				objWeeklyTradingStatementZoneObjects.ActualWagesPercentageTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementZoneObjects.Departments, objWeeklyTradingStatementZoneObjects.BudgetWages,
					objWeeklyTradingStatementZoneObjects.DataTable);
			BdgtWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementZoneObjects.TotalTitle,
					objWeeklyTradingStatementZoneObjects.BudgetWagesTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			BdgtWgPrcntVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementZoneObjects.Departments,
					objWeeklyTradingStatementZoneObjects.BudgetWagesPercentage,
					objWeeklyTradingStatementZoneObjects.DataTable);
			BdgtWgPrcntTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
					objWeeklyTradingStatementZoneObjects.TotalTitle,
					objWeeklyTradingStatementZoneObjects.BudgetWagesPercentageTtl);
		...
		PlndCPHVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementZoneObjects.Departments, objWeeklyTradingStatementZoneObjects.PlannedCPHWages,
				objWeeklyTradingStatementZoneObjects.DataTable);
		PlndCPHTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(objWeeklyTradingStatementZoneObjects.TotalTitle,
				objWeeklyTradingStatementZoneObjects.PlannedCPHWagesTtl);
		...
		PlndWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementZoneObjects.Departments, objWeeklyTradingStatementZoneObjects.PlannedWages,
				objWeeklyTradingStatementZoneObjects.DataTable);
		PlndWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(objWeeklyTradingStatementZoneObjects.TotalTitle,
				objWeeklyTradingStatementZoneObjects.PlannedWagesTtl);
		...
		PlndWgPrcntVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementZoneObjects.Departments,
				objWeeklyTradingStatementZoneObjects.PlannedWagesPercentage,
				objWeeklyTradingStatementZoneObjects.DataTable);
		PlndWgPrcntTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
				objWeeklyTradingStatementZoneObjects.TotalTitle,
				objWeeklyTradingStatementZoneObjects.PlannedWagesPercentageTtl);
		...
		CPHWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
				objWeeklyTradingStatementZoneObjects.Departments, objWeeklyTradingStatementZoneObjects.CPHWages,
				objWeeklyTradingStatementZoneObjects.DataTable);
		CPHWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(objWeeklyTradingStatementZoneObjects.TotalTitle,
				objWeeklyTradingStatementZoneObjects.CPHWagesTtl);
		...
		if (OptionToView.contains("Budget")) {
			...
			VarBdgtWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
					objWeeklyTradingStatementZoneObjects.Departments,
					objWeeklyTradingStatementZoneObjects.VarBudgetWages,
					objWeeklyTradingStatementZoneObjects.DataTable);
		...
		// Allowed Wages Validation
				if (OptionToView.contains("Budget")) {
					...
					AllowedWgVal = pageDailyTradingStatementGroupPO.RowWiseResult(objWeeklyTradingStatementStoreObjects,
							objWeeklyTradingStatementZoneObjects.Departments, objWeeklyTradingStatementZoneObjects.AllowedWages,
							objWeeklyTradingStatementZoneObjects.DataTable);
					AllowedWgTtl = pageDailyTradingStatementGroupPO.WeekToDateUITotal(
							objWeeklyTradingStatementZoneObjects.TotalTitle,
							objWeeklyTradingStatementZoneObjects.AllowedWagesTtl);
