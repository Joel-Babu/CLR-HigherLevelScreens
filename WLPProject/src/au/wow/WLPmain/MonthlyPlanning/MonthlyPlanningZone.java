...
public class MonthlyPlanningZone extends TestBase {

	protected Logger log = LogManager.getLogger(MonthlyPlanningZone.class);
	TestStatus status;
	...
	// Sales
	@Test(description = "Monthly Planning - Zone, Sales history - First Month", priority = 1)
	public void SalesHistoryFirstMonth() throws Exception {
		...
		// getContext().getStringProperty("MonthlyPlanningZone"));
	...
	@Test(description = "Monthly Planning - Zone, Sales history - Second Month", priority = 2)
	...
	@Test(description = "Monthly Planning - Zone, Sales history - Third Month", priority = 3)
	...
	@Test(description = "Monthly Planning - Zone, Sales history - Fourth Month", priority = 4)
	...
	// Wages
	@Test(description = "Monthly Planning - Zone, Wages history - First Month", priority = 5)
	...
	@Test(description = "Monthly Planning - Zone, Wages history - Second Month", priority = 6)
	...
	@Test(description = "Monthly Planning - Zone, Wages history - Third Month", priority = 7)
	...
	@Test(description = "Monthly Planning - Zone, Wages history - Fourth Month", priority = 8)
	...
	// Items
	@Test(description = "Monthly Planning - Zone, Items history - First Month", priority = 9)
	...
	@Test(description = "Monthly Planning - Zone, Items history - Second Month", priority = 10)
	...
	@Test(description = "Monthly Planning - Zone, Items history - Third Month", priority = 11)
	...
	@Test(description = "Monthly Planning - Zone, Items history - Fourth Month", priority = 12)
	...
	// Customers
	@Test(description = "Monthly Planning - Zone, Customers history - First Month", priority = 13)
	...
	@Test(description = "Monthly Planning - Zone, Customers history - Second Month", priority = 14)
	...
	@Test(description = "Monthly Planning - Zone, Customers history - Third Month", priority = 15)
	...
	@Test(description = "Monthly Planning - Zone, Customers history - Fourth Month", priority = 16)
	...
	// Item Price
	@Test(description = "Monthly Planning - Zone, Item Price history - First Month", priority = 17)
	...
	@Test(description = "Monthly Planning - Zone, Item Price history - Second Month", priority = 18)
	...
	@Test(description = "Monthly Planning - Zone, Item Price history - Third Month", priority = 19)
	...
	@Test(description = "Monthly Planning - Zone, Item Price history - Fourth Month", priority = 20)
	...
	// Wage Percentage
	@Test(description = "Monthly Planning - Zone, WagePercentage history - First Month", priority = 21)
	...
	@Test(description = "Monthly Planning - Zone, WagePercentage history - Second Month", priority = 22)
	...
	@Test(description = "Monthly Planning - Zone, WagePercentage history - Third Month", priority = 23)
	...
	@Test(description = "Monthly Planning - Zone, WagePercentage history - Fourth Month", priority = 24)
	...
	// Paid Hours
	@Test(description = "Monthly Planning - Zone, Paid Hours history - First Month", priority = 25)
	...
	@Test(description = "Monthly Planning - Zone, Paid Hours history - Second Month", priority = 26)
	...
	@Test(description = "Monthly Planning - Zone, Paid Hours history - Third Month", priority = 27)
	...
	@Test(description = "Monthly Planning - Zone, Paid Hours history - Fourth Month", priority = 28)
	...
	// CPH
	@Test(description = "Monthly Planning - Zone, CPH history - First Month", priority = 29)
	...
	@Test(description = "Monthly Planning - Zone, CPH history - Second Month", priority = 30)
	...
	@Test(description = "Monthly Planning - Zone, CPH history - Third Month", priority = 31)
	...
	@Test(description = "Monthly Planning - Zone, CPH history - Fourth Month", priority = 32)
	...
	////////////////////////// CURRENT MONTH ///////////////////////////////
	@Test(description = "Monthly Planning - Zone, Budget Sales - Current Month", priority = 37)
	...
	@Test(description = "Monthly Planning - Zone, Generated Sales- Current Month", priority = 38)
	...
	@Test(description = "Monthly Planning - Zone, Planned Sales- Current Month", priority = 39)
	...
	@Test(description = "Monthly Planning - Zone, Budget Wages - Current Month", priority = 43)
	...
	@Test(description = "Monthly Planning - Zone, BaseCost Wages - Current Month", priority = 44)
	...
	@Test(description = "Monthly Planning - Zone, Planned Wages - Current Month", priority = 45)
	...
	@Test(description = "Monthly Planning - Zone, Budget WagesPercentage - Current Month", priority = 47)
	...
	@Test(description = "Monthly Planning - Zone, Planned WagesPercentage - Current Month", priority = 48)
	...
	@Test(description = "Monthly Planning - Zone, LYWagesPercentage_CurrentMonth - Current Month", priority = 49)
	...
	@Test(description = "Monthly Planning - Zone, SMS Hours - Current Month", priority = 50)
	...
	@Test(description = "Monthly Planning - Zone, BaseHours - Current Month", priority = 51)
	...
	@Test(description = "Monthly Planning - Zone, PlannedHours - Current Month", priority = 52)
	...
	/*
	 * @Test(description =
	 * "Monthly Planning - Zone, Budget and Forecast Rate - Current Month",priority=
	...
	@Test(description = "Monthly Planning - Zone, Planned BDGT Rate - Current Month", priority = 48)
	...
	//////////////////////////////////////////////// CR 09
	//////////////////////////////////////////////// /////////////////////////////////////////////////////////////////
	@Test(description = "Monthly Planning - Zone, Var to BUD Sales- Current Month", priority = 40)
	...
	@Test(description = "Monthly Planning - Zone, LYPercentage Sales- Current Month", priority = 41)
	...
	@Test(description = "Monthly Planning - Zone, BudgetPercentage Sales- Current Month", priority = 42)
	...
	@Test(description = "Monthly Planning - Zone, LYPercentage Wages - Current Month", priority = 46)
	...
	@Test(description = "Monthly Planning - Zone, LYPercentage Hours - Current Month", priority = 53)
	...
	@Test(description = "Monthly Planning - Zone, Budget and Forecast OR - Current Month", priority = 54)
	...
	@Test(description = "Monthly Planning - Zone, Planned OR - Current Month", priority = 55)
	...
	@Test(description = "Monthly Planning - Zone, Planned CPH - Current Month", priority = 56)
	...
	@Test(description = "Monthly Planning - Zone, GrowthLY CPH - Current Month", priority = 57)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\MonthlyPlanningZone.xml");
