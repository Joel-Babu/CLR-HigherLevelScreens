...
public class MP_StoreToGroupComparision extends TestBase {

	protected Logger log = LogManager.getLogger(MP_StoreToGroupComparision.class);
	TestStatus status;
	...
	public MP_StoreToGroupComparision() {
		super.log = log;
	}
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Sales History", priority = 1)
	public void SalesHistoryFirstMonth() throws Exception {
		...
		List<List<Object>> SalesTotalValue = sql.executeQuery(getContext(),
				SalesHistoryTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Wages History", priority = 2)
	public void WagesHistoryFirsthMonth() throws Exception {
		pageWeeklyPlanningPO = new WeeklyPlanningStorePage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), WeeklyPlanningStorePage.class);
		pageWeeklyPlanningPO = new WeeklyPlanningStorePage().createPage(getDriver(), getContext(), log, status, data1,
				getReport(), getReportLogger(), WeeklyPlanningStorePage.class);
		TestStatus status = getTestStatus();
		System.out.println("Welcome " + getContext().getStringProperty("username"));
		System.out.println("Entering into TestCase");
		...
		TotalValue = sql.executeQuery(getContext(),
				WagesHistoryTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Items History", priority = 3)
	public void ItemsHistoryFirsthMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				ItemHistoryTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Customers History", priority = 4)
	public void CustomersHistoryFirsthMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(), CustomersHistoryTotal
				.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Paid Hours History", priority = 5)
	public void PaidHoursHistoryFirsthMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(), PaidHoursHistoryTotal
				.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - CPH History", priority = 6)
	public void CPHFirsthMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				CPHHistoryTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Wages % History", priority = 7)
	public void WagePercentageHistoryFirsthMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(), WagePercentageHistoryTotal
				.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Item Price History", priority = 8)
	public void ItemPriceHistoryFirsthMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(), ItemPriceHistoryTotal
				.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - BudgetSales", priority = 9)
	public void BudgetSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			TotalValue = sql.executeQuery(getContext(),
					BudgetSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
		...
		if (OptionToView.contains("Forecast")) {
			...
			TotalValue = sql.executeQuery(getContext(), ForecastSalesTotal
					.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - GeneratedSales", priority = 10)
	public void GeneratedSales_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				GeneratedSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - PlannedSales", priority = 11)
	public void PlannedSales_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				PlannedSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - VarToBUD_FCST Sales", priority = 12)
	public void VarToBUDSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			TotalValue = sql.executeQuery(getContext(),
					VartoBUDTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
		...
		if (OptionToView.contains("Forecast")) {
			...
			TotalValue = sql.executeQuery(getContext(),
					VartoFCSTTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - LYPercentage Sales", priority = 13)
	public void LYPercentageSales_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				LYPercentageSalesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - BudgetPercentage Sales", priority = 14)
	public void BudgetPercentageSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			TotalValue = sql.executeQuery(getContext(), BUDPercentageSalesTotal
					.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
		...
		if (OptionToView.contains("Forecast")) {
			...
			TotalValue = sql.executeQuery(getContext(), FCSTPercentageSalesTotal
					.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
	...
	// Wages
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Budget_Forecast Wages", priority = 15)
	public void BudgetWages_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			TotalValue = sql.executeQuery(getContext(),
					BudgetWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
		...
		if (OptionToView.contains("Forecast")) {
			...
			TotalValue = sql.executeQuery(getContext(), ForecastWagesTotal
					.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - BaseCost Wages", priority = 16)
	public void BaseCostWages_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				BaseCostWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Wages", priority = 17)
	public void PlannedWages_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				PlannedWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - LYPercentage Wages", priority = 18)
	public void LYPercentageWages_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				LYPercentageWagesTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month)
						.replace("LYMnth", LYMonthName));
		System.out.println("DB Value: " + TotalValue);
	...
	// Wages %
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Budget_Forecast Wages %", priority = 19)
	public void BudgetWagesPercentage_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			TotalValue = sql.executeQuery(getContext(), BudgetWagesPercentageTotal
					.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
		...
		if (OptionToView.contains("Forecast")) {
			...
			TotalValue = sql.executeQuery(getContext(), ForecastWagesPercentageTotal
					.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
			System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Wages %", priority = 20)
	public void PlannedWagesPercentage_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(), PlannedWagesPercentageTotal
				.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - LY Wages%", priority = 21)
	public void LYWagesPercentage_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				LYWagesPercentageTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month)
						.replace("LYMnth", LYMonthName));
		System.out.println("DB Value: " + TotalValue);
	...
	// Hours
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - SMS Hours", priority = 22)
	public void SMSHours_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				SMSHoursTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Base Hours", priority = 23)
	public void BaseHours_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				BaseHoursTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Hours", priority = 24)
	public void PlannedHours_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				PlannedHoursTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - LY% Hours", priority = 25)
	public void LYPercentageHours_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				LYHoursTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month)
						.replace("LYMnth", LYMonthName));
		System.out.println("DB Value: " + TotalValue);
		...
		pageDBComparisionPO.CompareValueDecimalFields(extentTest, TotalValue, IndividualValue, "LY% Hours");
	}

	// OR
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned OR", priority = 26)
	public void PlannedOR_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				PlannedORTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	// CPH
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned CPH", priority = 27)
	public void PlannedCPH_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				PlannedCPHTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month));
		System.out.println("DB Value: " + TotalValue);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - GrowthLY CPH", priority = 28)
	public void GrowthLYCPH_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				GrowthLYCPHTotal.replace("store", getContext().getStringProperty("store")).replace("Month", Month)
						.replace("LYMnth", LYMonthName));
		;
		System.out.println("DB Value: " + TotalValue);
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\MonthlyPlanningGroup.xml");
