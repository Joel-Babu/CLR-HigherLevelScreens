...
public class MonthlyPlanningGroup extends TestBase {

	protected Logger log = LogManager.getLogger(MonthlyPlanningGroup.class);
	TestStatus status;
	...
	// Sales
	@Test(description = "Monthly Planning - Group, Sales history - First Month", priority = 1)
	public void SalesHistoryFirstMonth() throws Exception {
		...
		UIValues = pageWeeklyPlanningPO.UIResultsMP(objMonthlyPlanningGroupObjects.MPTable, extentTest,
	...
	@Test(description = "Monthly Planning - Group, Sales history - Second Month", priority = 2)
	...
	@Test(description = "Monthly Planning - Group, Sales history - Third Month", priority = 3)
	...
	@Test(description = "Monthly Planning - Group, Sales history - Fourth Month", priority = 4)
	...
	// Wages
	@Test(description = "Monthly Planning - Group, Wages history - First Month", priority = 5)
	...
	@Test(description = "Monthly Planning - Group, Wages history - Second Month", priority = 6)
	...
	@Test(description = "Monthly Planning - Group, Wages history - Third Month", priority = 7)
	...
	@Test(description = "Monthly Planning - Group, Wages history - Fourth Month", priority = 8)
	...
	// Items
	@Test(description = "Monthly Planning - Group, Items history - First Month", priority = 9)
	...
	@Test(description = "Monthly Planning - Group, Items history - Second Month", priority = 10)
	...
	@Test(description = "Monthly Planning - Group, Items history - Third Month", priority = 11)
	...
	@Test(description = "Monthly Planning - Group, Items history - Fourth Month", priority = 12)
	...
	// Customers
	@Test(description = "Monthly Planning - Group, Customers history - First Month", priority = 13)
	...
	@Test(description = "Monthly Planning - Group, Customers history - Second Month", priority = 14)
	...
	@Test(description = "Monthly Planning - Group, Customers history - Third Month", priority = 15)
	...
	@Test(description = "Monthly Planning - Group, Customers history - Fourth Month", priority = 16)
	...
	// Item Price
	@Test(description = "Monthly Planning - Group, Item Price history - First Month", priority = 17)
	...
	@Test(description = "Monthly Planning - Group, Item Price history - Second Month", priority = 18)
	...
	@Test(description = "Monthly Planning - Group, Item Price history - Third Month", priority = 19)
	...
	@Test(description = "Monthly Planning - Group, Item Price history - Fourth Month", priority = 20)
	...
	// Wage Percentage
	@Test(description = "Monthly Planning - Group, WagePercentage history - First Month", priority = 21)
	...
	@Test(description = "Monthly Planning - Group, WagePercentage history - Second Month", priority = 22)
	...
	@Test(description = "Monthly Planning - Group, WagePercentage history - Third Month", priority = 23)
	...
	@Test(description = "Monthly Planning - Group, WagePercentage history - Fourth Month", priority = 24)
	...
	// Paid Hours
	@Test(description = "Monthly Planning - Group, Paid Hours history - First Month", priority = 25)
	...
	@Test(description = "Monthly Planning - Group, Paid Hours history - Second Month", priority = 26)
	...
	@Test(description = "Monthly Planning - Group, Paid Hours history - Third Month", priority = 27)
	...
	@Test(description = "Monthly Planning - Group, Paid Hours history - Fourth Month", priority = 28)
	...
	// CPH
	@Test(description = "Monthly Planning - Group, CPH history - First Month", priority = 29)
	...
	@Test(description = "Monthly Planning - Group, CPH history - Second Month", priority = 30)
	...
	@Test(description = "Monthly Planning - Group, CPH history - Third Month", priority = 31)
	...
	@Test(description = "Monthly Planning - Group, CPH history - Fourth Month", priority = 32)
	...
	////////////////////////// CURRENT MONTH ///////////////////////////////
	@Test(description = "Monthly Planning - Group, Budget Sales - Current Month", priority = 37)
	...
	@Test(description = "Monthly Planning - Group, Generated Sales- Current Month", priority = 38)
	...
	@Test(description = "Monthly Planning - Group, Planned Sales- Current Month", priority = 39)
	...
	@Test(description = "Monthly Planning - Group, Budget Wages - Current Month", priority = 43)
	...
	@Test(description = "Monthly Planning - Group, BaseCost Wages - Current Month", priority = 44)
	...
	@Test(description = "Monthly Planning - Group, Planned Wages - Current Month", priority = 45)
	...
	@Test(description = "Monthly Planning - Group, Budget WagesPercentage - Current Month", priority = 47)
	...
	@Test(description = "Monthly Planning - Group, Planned WagesPercentage - Current Month", priority = 48)
	...
	@Test(description = "Monthly Planning - Group, LYWagesPercentage_CurrentMonth - Current Month", priority = 49)
	...
	@Test(description = "Monthly Planning - Group, SMS Hours - Current Month", priority = 50)
	...
	@Test(description = "Monthly Planning - Group, BaseHours - Current Month", priority = 51)
	...
	@Test(description = "Monthly Planning - Group, PlannedHours - Current Month", priority = 52)
	...
	@Test(description = "Monthly Planning - Group, Planned BDGT Rate - Current Month", priority = 48)
	...
	/*
	 * @Test(description =
	 * "Monthly Planning - Group, Budget and Forecast Rate - Current Month",priority
	 ...
	 * 
	 * UIValues =
	 * pageWeeklyPlanningPO.UIResultsMP(objMonthlyPlanningGroupObjects.MPTable,
	...
	//////////////////////////////////////////////// CR 09
	//////////////////////////////////////////////// /////////////////////////////////////////////////////////////////
	@Test(description = "Monthly Planning - Group, Var to BUD Sales- Current Month", priority = 40)
	...
	@Test(description = "Monthly Planning - Group, LYPercentage Sales- Current Month", priority = 41)
	...
	@Test(description = "Monthly Planning - Group, BudgetPercentage Sales- Current Month", priority = 42)
	...
	@Test(description = "Monthly Planning - Group, LYPercentage Wages - Current Month", priority = 46)
	...
	@Test(description = "Monthly Planning - Group, LYPercentage Hours - Current Month", priority = 53)
	...
	@Test(description = "Monthly Planning - Group, Budget or Forecast OR - Current Month", priority = 54)
	...
	@Test(description = "Monthly Planning - Group, Planned OR - Current Month", priority = 55)
	...
	@Test(description = "Monthly Planning - Group, Planned CPH - Current Month", priority = 56)
	...
	@Test(description = "Monthly Planning - Group, GrowthLY CPH - Current Month", priority = 57)
