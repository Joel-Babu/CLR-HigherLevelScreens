...
public class MP_StateToBusinessUnitComparison extends TestBase {

	protected Logger log = LogManager.getLogger(MP_StateToBusinessUnitComparison.class);
	TestStatus status;
	...
	public MP_StateToBusinessUnitComparison() {
		super.log = log;
	}
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Sales History", priority = 1)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Wages History", priority = 2)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Items History", priority = 3)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Customers History", priority = 4)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Paid Hours History", priority = 5)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - CPH History", priority = 6)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Wages % History", priority = 7)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Item Price History", priority = 8)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - BudgetSales", priority = 9)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - GeneratedSales", priority = 10)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - PlannedSales", priority = 11)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - VarToBUD_FCST Sales", priority = 12)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - LYPercentage Sales", priority = 13)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - BudgetPercentage Sales", priority = 14)
	...
	// Wages
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Budget_Forecast Wages", priority = 15)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - BaseCost Wages", priority = 16)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Planned Wages", priority = 17)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - LYPercentage Wages", priority = 18)
	...
	// Wages %
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Budget_Forecast Wages %", priority = 19)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Planned Wages %", priority = 20)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - LY Wages%", priority = 21)
	...
	// Hours
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - SMS Hours", priority = 22)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Base Hours", priority = 23)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Planned Hours", priority = 24)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - LY% Hours", priority = 25)
	...
	// OR
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Planned OR", priority = 26)
	...
	// CPH
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - Planned CPH", priority = 27)
	...
	@Test(description = "Verify State Total Value and Respective BU Value in BU Screen - GrowthLY CPH", priority = 28)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\MonthlyPlanningBU_WOWGroup.xml");
