...
public class WP_BusinessUnitToWOWGroupComparison extends TestBase {

	protected Logger log = LogManager.getLogger(WP_BusinessUnitToWOWGroupComparison.class);
	TestStatus status;
	...
	public WP_BusinessUnitToWOWGroupComparison() {
		super.log = log;
	}
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Sales History", priority = 1)
	public void SalesHistoryFirstWeek() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToView, getContext().getStringProperty("WeeklyPlanningWOWGroup"));
		...
		String SalesHistory = data1.getText("SalesHistoryTotal");
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Wages History", priority = 2)
	public void WagesHistoryFirstWeek() throws Exception {
		...
		String WagesHistory = data1.getText("WagesHistoryTotal");
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Items History", priority = 3)
	public void ItemsHistoryFirsthWeek() throws Exception {
		...
		String ItemsHistory = data1.getText("ItemsHistoryTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Customers History", priority = 4)
	public void CustomersHistoryFirsthWeek() throws Exception {
		...
		String CustomerHistory = data1.getText("CustomerHistoryTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Paid Hours History", priority = 5)
	public void PaidHoursHistoryFirsthWeek() throws Exception {
		...
		String PaidHoursHistory = data1.getText("PaidHoursHistoryTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - CPH History", priority = 6)
	public void CPHHistoryFirsthWeek() throws Exception {
		...
		String CPHHistory = data1.getText("CPHHistoryTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Wages % History", priority = 7)
	public void WagePercentageHistoryFirsthWeek() throws Exception {
		...
		String WagePercentageHistory = data1.getText("WagePercentageHistoryTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Item Price History", priority = 8)
	public void ItemPriceHistoryFirsthWeek() throws Exception {
		...
		String ItemPriceHistory = data1.getText("ItemPriceHistoryTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - OR History", priority = 8)
	public void ORHistoryFirstWeek() throws Exception {
		...
		pageWeeklyPlanningPO.VerifyUserName(objWeeklyPlanningStoreObjects, extentTest,
				getContext().getStringProperty("username2"));
		pageWeeklyPlanningPO.SelectWeekFromDropdown(objWeeklyPlanningStoreObjects, extentTest,
				getContext().getStringProperty("SelectFiscalWeek"));
		pageWeeklyPlanningPO.SelectPage(objWeeklyPlanningStoreObjects,
				getContext().getStringProperty("WeeklyPlanningWOWGroup"), extentTest);
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - BudgetSales", priority = 9)
	public void BudgetSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			TotalValue = sql.executeQuery(getContext(),
					BudgetSalesTotal.replace("Region", getContext().getStringProperty("Region"))
							...
							.replace("store", getContext().getStringProperty("store"))
							.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
							.replace("FinYear", LYYr).replace("Division", getContext().getStringProperty("Division")));
			System.out.println("DB Value: " + TotalValue);

			String BudgetSales = data1.getText("BudgetSalesTotal");
			IndividualValue = sql1.executeQuery(getContext(),
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastSales = data1.getText("ForecastSalesTotal");
			IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - GeneratedSales", priority = 10)
	public void GeneratedSales_CurrentMonth() throws Exception {
		...
		String GeneratedSales = data1.getText("GeneratedSalesTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - PlannedSales", priority = 11)
	public void PlannedSales_CurrentMonth() throws Exception {
		...
		String PlannedSales = data1.getText("PlannedSalesTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - VarToBUD_FCST Sales", priority = 12)
	public void VarToBUDSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			String VartoBUD = data1.getText("VartoBUDTotal");
			IndividualValue = sql1.executeQuery(getContext(),
		...
		if (OptionToView.contains("Forecast")) {
			...
			String VartoFCST = data1.getText("VartoFCSTTotal");
			IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - LYPercentage Sales", priority = 13)
	public void PercentageLYsales_CurrentMonth() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				PercentLYSalesTotal.replace("Region", getContext().getStringProperty("Region"))
						...
						.replace("store", getContext().getStringProperty("store"))
						.replace("Zone", getContext().getStringProperty("Zone")).replace("FinWeek", Week)
						.replace("FinYear", LYYr).replace("LYFinYr", Year)
						.replace("Division", getContext().getStringProperty("Division")));
		System.out.println("DB Value: " + TotalValue);

		String PercentLYSales = data1.getText("PercentLYSalesTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - BudgetPercentage Sales", priority = 14)
	public void BudgetPercentageSales_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			String BudgetPercentage = data1.getText("BudgetPercentageTotal");
			IndividualValue = sql1.executeQuery(getContext(),
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastPercentage = data1.getText("ForecastPercentageSalesTotal");
			IndividualValue = sql1.executeQuery(getContext(),
	...
	// Wages
	@Test(description = "Verify BU Total Value in WOW Group Screen - Budget_Forecast Wages", priority = 15)
	public void BudgetWages_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			String BudgetWages = data1.getText("BudgetWagesTotal");
			IndividualValue = sql1.executeQuery(getContext(),
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastWages = data1.getText("ForecastWagesTotal");
			IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned Wages", priority = 16)
	public void PlannedWages_CurrentMonth() throws Exception {
		...
		String PlannedWages = data1.getText("PlannedWagesTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - LYPercentage Wages", priority = 17)
	public void PlannedLYWages_CurrentMonth() throws Exception {
		...
		String PlannedLYWages = data1.getText("PlannedLYWagesTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	// Wages %
	@Test(description = "Verify BU Total Value in WOW Group Screen - Budget_Forecast Wages %", priority = 18)
	public void BudgetWagesPercentage_CurrentMonth() throws Exception {
		...
		if (OptionToView.contains("Budget")) {
			...
			String BudgetWagesPercentage = data1.getText("BudgetWagesPercentageTotal");
			IndividualValue = sql1.executeQuery(getContext(),
		...
		if (OptionToView.contains("Forecast")) {
			...
			String ForecastWagesPercentage = data1.getText("ForecastWagesPercentageTotal");
			IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned Wages %", priority = 19)
	public void PlannedWagesPercentage_CurrentMonth() throws Exception {
		...
		String PlannedWagesPercentage = data1.getText("PlannedWagesPercentageTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - LY Wages%", priority = 20)
	public void LYWagesPercentage_CurrentMonth() throws Exception {
		...
		String LYWagesPercentage = data1.getText("LYWagesPercentageTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	// Hours
	@Test(description = "Verify BU Total Value in WOW Group Screen - SMS Hours", priority = 21)
	public void SMSHours_CurrentMonth() throws Exception {
		...
		String SMSHours = data1.getText("SMSHoursTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Base Hours", priority = 22)
	public void PlannedHours_CurrentMonth() throws Exception {
		...
		String PlannedHours = data1.getText("PlannedHoursTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned Hours", priority = 23)
	public void HoursLY_CurrentMonth() throws Exception {
		...
		String HoursLY = data1.getText("HoursLYTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	// OR
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned OR", priority = 24)
	public void PlannedOR_CurrentMonth() throws Exception {
		...
		String plannedOR = data1.getText("plannedORTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	// CPH
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned CPH", priority = 25)
	public void PlannedCPH_CurrentMonth() throws Exception {
		...
		String PlannedCPH = data1.getText("PlannedCPHTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - GrowthLY CPH", priority = 26)
	public void GrowthLYCPH_CurrentMonth() throws Exception {
		...
		String GrowthLYCPH = data1.getText("GrowthLYCPHTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned Items", priority = 27)
	public void PlannedItems_CurrentMonth() throws Exception {
		...
		String PlannedItems = data1.getText("PlannedItemsTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - PlannedIPLHitems", priority = 28)
	public void PlannedIPLHitems_CurrentMonth() throws Exception {
		...
		String PlannedIPLHitems = data1.getText("PlannedIPLHitemsTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - Planned ItemPrice", priority = 29)
	public void PlannedItemPrice_CurrentMonth() throws Exception {
		...
		String PlannedItemPrice = data1.getText("PlannedItemPriceTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen - PlannedPercentOnLY", priority = 30)
	public void PlannedPercentOnLY_CurrentMonth() throws Exception {
		...
		String PlannedpercentonLY = data1.getText("PlannedpercentonLYTotal");
		IndividualValue = sql1.executeQuery(getContext(),
	...
	@Test(description = "Verify BU Total Value in WOW Group Screen, MonthlyViewMetricsValidation", priority = 31)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyPlanningWOWGroup.xml");
