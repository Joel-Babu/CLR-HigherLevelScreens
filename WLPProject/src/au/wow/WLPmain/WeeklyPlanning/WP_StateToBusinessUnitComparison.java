...
public class WP_StateToBusinessUnitComparison extends TestBase {

	protected Logger log = LogManager.getLogger(WP_StateToBusinessUnitComparison.class);
	TestStatus status;
	...
	public WP_StateToBusinessUnitComparison() {
		super.log = log;
	}
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Sales History", priority = 1)
	public void SalesHistoryFirstWeek() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToView, getContext().getStringProperty("WeeklyPlanningState"));
		...
		// pageMonthlyPlanningGroupPO.SelectGroupDropdownToView(objMonthlyPlanningGroupObjects,extentTest,getContext().getStringProperty("RegionToView"));
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Wages History", priority = 2)
	public void WagesHistoryFirstWeek() throws Exception {
		...
		pageMonthlyPlanningGroupPO.SelectGroupDropdownToView(objMonthlyPlanningGroupObjects, extentTest,
				getContext().getStringProperty("RegionToView"));
		Name = pageWeeklyPlanningPO.MonthName(objWeeklyPlanningStoreObjects, extentTest,
				objWeeklyPlanningStoreObjects.FirstWeekofMonth);
		YrName = pageWeeklyPlanningPO.MonthName(objWeeklyPlanningStoreObjects, extentTest,
				objWeeklyPlanningStoreObjects.CurrentWeekBGDT);
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Items History", priority = 3)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Customers History", priority = 4)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Paid Hours History", priority = 5)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - CPH History", priority = 6)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Wages % History", priority = 7)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Item Price History", priority = 8)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - BudgetSales", priority = 9)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - GeneratedSales", priority = 10)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - PlannedSales", priority = 11)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - VarToBUD_FCST Sales", priority = 12)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - LYPercentage Sales", priority = 13)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - BudgetPercentage Sales", priority = 14)
	...
	// Wages
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Budget_Forecast Wages", priority = 15)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned Wages", priority = 16)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - LYPercentage Wages", priority = 17)
	...
	// Wages %
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Budget_Forecast Wages %", priority = 18)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned Wages %", priority = 19)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - LY Wages%", priority = 20)
	...
	// Hours
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - SMS Hours", priority = 21)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Base Hours", priority = 22)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned Hours", priority = 23)
	...
	// OR
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned OR", priority = 24)
	...
	// CPH
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned CPH", priority = 25)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - GrowthLY CPH", priority = 26)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned Items", priority = 27)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - PlannedIPLHitems", priority = 28)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - Planned ItemPrice", priority = 29)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen - PlannedPercentOnLY", priority = 30)
	...
	@Test(description = "Verify State Total Value and Respective State Value in BU Screen, MonthlyViewMetricsValidation", priority = 31)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyPlanningBU.xml");
