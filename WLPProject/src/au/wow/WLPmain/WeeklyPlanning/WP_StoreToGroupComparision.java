...
public class WP_StoreToGroupComparision extends TestBase {

	protected Logger log = LogManager.getLogger(WP_StoreToGroupComparision.class);
	TestStatus status;
	...
	public WP_StoreToGroupComparision() {
		super.log = log;
	}
	...
	public void SalesHistoryFirstWeek() throws Exception {
		...
		// pageWeeklyPlanningPO.SelectPage(objWeeklyPlanningStoreObjects,getContext().getStringProperty("WeeklyPlanningGroup"),extentTest);
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - OR History", priority = 9)
	public void ORHistoryFirstWeek() throws Exception {
		...
		TotalValue = sql.executeQuery(getContext(),
				ORHistoryTotal.replace("store", getContext().getStringProperty("store"))
						.replace("Area", getContext().getStringProperty("Area"))
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Wages", priority = 16)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - LYPercentage Wages", priority = 17)
	...
	// Wages %
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Budget_Forecast Wages %", priority = 18)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Wages %", priority = 19)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - LY Wages%", priority = 20)
	...
	// Hours
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - SMS Hours", priority = 21)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Base Hours", priority = 22)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Hours", priority = 23)
	...
	// OR
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned OR", priority = 24)
	...
	// CPH
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned CPH", priority = 25)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - GrowthLY CPH", priority = 26)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned Items", priority = 27)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - PlannedIPLHitems", priority = 28)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Planned ItemPrice", priority = 29)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - PlannedPercentOnLY", priority = 30)
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen, MonthlyViewMetricsValidation", priority = 31)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyPlanningGroup.xml");
