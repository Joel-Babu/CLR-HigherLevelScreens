...
public class ComparisionofStoretoGroupTotal extends TestBase {
	protected Logger log = LogManager.getLogger(ComparisionofStoretoGroupTotal.class);
	TestStatus status;
	...
	public ComparisionofStoretoGroupTotal() {
		super.log = log;
	}
	...
	public void SalesColumnValidation() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToView, getContext().getStringProperty("WTSStore"));
	...
	///// CPH///
	@Test(description = "Weekly Trading Statement - Store, CPHColumnValidationNewTable", priority = 9)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyTradingStatementGroup.xml");
