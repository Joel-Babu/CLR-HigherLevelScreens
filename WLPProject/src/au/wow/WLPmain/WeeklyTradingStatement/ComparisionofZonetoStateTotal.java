...
public class ComparisionofZonetoStateTotal extends TestBase {
	...
	///// CPH///
	@Test(description = "Weekly Trading Statement - Zone, CPHColumnValidationNewTable", priority = 9)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyTradingStatementState.xml");
