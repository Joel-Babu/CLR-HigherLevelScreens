...
public class ComparisionofStatetoBUTotal extends TestBase {
	protected Logger log = LogManager.getLogger(ComparisionofStatetoBUTotal.class);
	TestStatus status;
	...
	public ComparisionofStatetoBUTotal() {
		super.log = log;
	}
	...
	public void SalesColumnValidation() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.screenToView, getContext().getStringProperty("WTSState"));
	...
	///// CPH///
	@Test(description = "Weekly Trading Statement - State, CPHColumnValidationNewTable", priority = 9)
	...
	public void loadXMLFile() {
		try {
			...
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\WeeklyTradingStatementBU.xml");
