...
public class DailyPlanningWOWGroup extends TestBase {

	protected Logger log = LogManager.getLogger(DailyPlanningWOWGroup.class);
	TestStatus status;
	...
	@Test(description = "Daily Planning - Woolworths Group, Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.DPscreenToView, "Woolworths Group");
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("DailyPlanningWOWGroup"));*/
		...
		for (int i = 0; i <= 2; i++) {
			...
			String SalesColumn = data.getText("" + OptionToView + "SalesTotal");
			...
			String SalesWkToDt = data.getText("" + OptionToView + "SalesWkToDtTotal");
	...
	@Test(description = "Daily Planning - Woolworths Group, Hours View", priority = 2)
	public void ScheduledHoursView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			if (i == 0) {
				...
				String HoursColumn = data.getText("" + OptionToView + "HoursTotal");
				DBValues = sql.CLRexecuteQuery(getContext(),
				...
				String HoursWkToDt = data.getText("" + OptionToView + "HoursWkToDtTotal");
				DBWkToDate = sql.CLRexecuteQuery(getContext(),
			...
			if (i == 1) {
				...
				// Pay Hours
				String PayHoursColumn = data.getText("" + OptionToView + "PayHoursTotal");
				...
				String PayHoursWkToDt = data.getText("" + OptionToView + "PayHoursWkToDtTotal");
				...
				pageDailyTradingStatementStorePO.CompareValueDecimalORFields(extentTest, PayHoursDBValues,PayHoursUIValues);
	...
	@Test(description = "Daily Planning - Woolworths Group, Wages View", priority = 3)
	public void WagesView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			String WagesColumn = data.getText("" + OptionToView + "WagesTotal");
			DBValues = sql.CLRexecuteQuery(getContext(),
			...
			String WagesWkToDt = data.getText("" + OptionToView + "WagesWkToDtTotal");
			DBWkToDate = sql.CLRexecuteQuery(getContext(),
	...
	@Test(description = "Daily Planning - Woolworths Group, WagesPercentage View", priority = 4)
	public void WagesPercentageView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			String WagesPrcntColumn = data.getText("" + OptionToView + "WagesPrcntTotal");
			DBValues = sql.CLRexecuteQuery(getContext(),
			...
			String WagesPrcntWkToDt = data.getText("" + OptionToView + "WagesPrcntWkToDtTotal");
			DBWkToDate = sql.CLRexecuteQuery(getContext(),
	...
	@Test(description = "Daily Planning - Woolworths Group, Operatinoal Ratio View", priority = 5)
	public void ORPercentageView() throws Exception {

		extentTest = report.startTest("Daily Planning - Woolworths Group, Operatinoal Ratio View");
		pageWeeklyPlanningPO = new WeeklyPlanningStorePage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), WeeklyPlanningStorePage.class);
		pageDailyPlanningPO = new DailyPlanningPage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), DailyPlanningPage.class);
		...
		for (int i = 0; i <= 2; i++) {
			if (i == 0) {
				...
				String ORPrcntColumn = data.getText("" + OptionToView + "ORPrcntTotal");
				DBValues = sql.CLRexecuteQuery(getContext(),
				...
				String ORPrcntWkToDt = data.getText("" + OptionToView + "ORPrcntWkToDtTotal");
				DBWkToDate = sql.CLRexecuteQuery(getContext(),
			...
			/*if (i == 1) {
				...
				String ORPrcntColumnPayPlan = data.getText("" + OptionToView + "ORPrcntTotalPayPlan");
				...
				String ORPrcntWkToDtPayPlan = data.getText("" + OptionToView + "ORPrcntWkToDtTotalPayPlan");
	...
	@Test(description = "Daily Planning - Woolworths Group, Items View", priority = 6)
	public void ItemsView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			String ItemsColumn = data.getText("" + OptionToView + "ItemsTotal");
			DBValues = sql.CLRexecuteQuery(getContext(),
			...
			String ItemsWkToDt = data.getText("" + OptionToView + "ItemsWkToDtTotal");
			DBWkToDate = sql.CLRexecuteQuery(getContext(),
	...
	@Test(description = "Daily Planning - Woolworths Group, Items Price View", priority = 7)
	public void ItemsPriceView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			String ItemsPriceColumn = data.getText("" + OptionToView + "ItemsPriceTotal");
			DBValues = sql.CLRexecuteQuery(getContext(),
			...
			String ItemsPriceWkToDt = data.getText("" + OptionToView + "ItemsPriceWkToDtTotal");
			DBWkToDate = sql.CLRexecuteQuery(getContext(),
	...
	@Test(description = "Daily Planning - Woolworths Group, Customers View", priority = 8)
	public void CustomersView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			String CustomersColumn = data.getText("" + OptionToView + "CustomersTotal");
			DBValues = sql.CLRexecuteQuery(getContext(),
			...
			String CustomersWkToDt = data.getText("" + OptionToView + "CustomersWkToDtTotal");
			DBWkToDate = sql.CLRexecuteQuery(getContext(),
	...
	@Test(description = "Daily Planning - Woolworths Group, CPH View", priority = 9)
	public void CPHView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			String CPHColumn = data.getText("" + OptionToView + "CPHTotal");
			DBValues = sql.CLRexecuteQuery(getContext(),
			...
			String CPHWkToDt = data.getText("" + OptionToView + "CPHWkToDtTotal");
			DBWkToDate = sql.CLRexecuteQuery(getContext(),
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningBU_ALL.xml");
