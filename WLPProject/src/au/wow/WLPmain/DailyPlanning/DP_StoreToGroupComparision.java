...
public class DP_StoreToGroupComparision extends TestBase {

	protected Logger log = LogManager.getLogger(DP_StoreToGroupComparision.class);
	TestStatus status;
	...
	public DP_StoreToGroupComparision() {
		super.log = log;
	}
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				...
				String DailyPlanningStore = "STORE TO GROUP - Planned Sales View";
				Report_AddStep("testcase", " PLANNED SALES VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Sales View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals Sales View";
				Report_AddStep("testcase", " ACTUAL SALES VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals Sales View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance Sales View";
				Report_AddStep("testcase", " VARIANCE SALES VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Sales View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Hours View", priority = 2)
	public void ScheduledHoursView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP  -Planned Hours View";
				Report_AddStep("testcase", " PLANNED HOURS VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Hours View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP  - Actuals Hours View";
				Report_AddStep("testcase", " ACTUAL HOURS VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals Hours View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP  - Variance Hours View";
				Report_AddStep("testcase", " VARIANCE HOURS VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Hours View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Wages View", priority = 3)
	public void WagesView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned Wages View";
				Report_AddStep("testcase", " PLANNED WAGES VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Wages View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals Wages View";
				Report_AddStep("testcase", " ACTUAL WAGES VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals Wages View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance Wages View";
				Report_AddStep("testcase", " VARIANCE WAGES VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Wages View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Wages Percentage View", priority = 4)
	public void WagesPercentageView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned Wages Percentage View";
				Report_AddStep("testcase", " PLANNED WAGEPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Wages Percentage View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals Wages Percentage View";
				Report_AddStep("testcase", " ACTUAL WAGEPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals Wages Percentage View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance Wages Percentage View";
				Report_AddStep("testcase", " VARIANCE WAGEPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Wages Percentage View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - OR Percentage View", priority = 5)
	public void ORPercentageView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned OR Percentage View";
				Report_AddStep("testcase", " PLANNED ORPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned OR Percentage View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals OR Percentage View";
				Report_AddStep("testcase", " ACTUAL ORPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals OR Percentage View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance OR Percentage View";
				Report_AddStep("testcase", " VARIANCE ORPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance OR Percentage View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Items View", priority = 6)
	public void ItemsView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned Items View";
				Report_AddStep("testcase", " PLANNED ITEMS VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Items View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals Items View";
				Report_AddStep("testcase", " ACTUAL ITEMS VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals Items View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance Items View";
				Report_AddStep("testcase", " VARIANCE ITEMS VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Items View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Item Price View", priority = 7)
	public void ItemsPriceView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned Item Price View";
				Report_AddStep("testcase", " PLANNED ITEM PRICE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Item Price View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actual Item Price View";
				Report_AddStep("testcase", " ACTUAL ITEM PRICE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actual Item Price View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance Item Price View";
				Report_AddStep("testcase", " VARIANCE ITEM PRICE VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Item Price View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - Customer View", priority = 8)
	public void CustomersView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned Customer View";
				Report_AddStep("testcase", " PLANNED CUSTOMER VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned Customer View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals Customer View";
				Report_AddStep("testcase", " ACTUAL CUSTOMER VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals Customer View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance Customer View";
				Report_AddStep("testcase", " VARIANCE CUSTOMER VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance Customer View");
	...
	@Test(description = "Verify Store Total Value and Respective Store Value in Group Screen - CPH View", priority = 9)
	public void CPHView() throws Exception {
		...
		for (int i = 0; i <= 1; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "STORE TO GROUP - Planned CPH View";
				Report_AddStep("testcase", " PLANNED CPH VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Planned CPH View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "STORE TO GROUP - Actuals CPH View";
				Report_AddStep("testcase", " ACTUAL CPH VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Actuals CPH View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "STORE TO GROUP - Variance CPH View";
				Report_AddStep("testcase", " VARIANCE CPH VIEW ", "", "", "");
				extentTest = report.startTest("STORE TO GROUP - Variance CPH View");
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningStoreComparision.xml");
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningGroup.xml");
