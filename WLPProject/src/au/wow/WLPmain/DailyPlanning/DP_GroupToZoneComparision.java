...
public class DP_GroupToZoneComparision extends TestBase {

	protected Logger log = LogManager.getLogger(DP_GroupToZoneComparision.class);
	TestStatus status;
	...
	public DP_GroupToZoneComparision() {
		super.log = log;
	}
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				...
				String DailyPlanningStore = "GROUP to ZONE - Planned Sales View";
				Report_AddStep("testcase", " PLANNED SALES VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Sales View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals Sales View";
				Report_AddStep("testcase", " ACTUAL SALES VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals Sales View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance Sales View";
				Report_AddStep("testcase", " VARIANCE SALES VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Sales View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Hours View", priority = 2)
	public void ScheduledHoursView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE  -Planned Hours View";
				Report_AddStep("testcase", " PLANNED HOURS VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Hours View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE  - Actuals Hours View";
				Report_AddStep("testcase", " ACTUAL HOURS VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals Hours View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE  - Variance Hours View";
				Report_AddStep("testcase", " VARIANCE HOURS VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Hours View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Wages View", priority = 3)
	public void WagesView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned Wages View";
				Report_AddStep("testcase", " PLANNED WAGES VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Wages View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals Wages View";
				Report_AddStep("testcase", " ACTUAL WAGES VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals Wages View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance Wages View";
				Report_AddStep("testcase", " VARIANCE WAGES VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Wages View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Wages Percentage View", priority = 4)
	public void WagesPercentageView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned Wages Percentage View";
				Report_AddStep("testcase", " PLANNED WAGEPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Wages Percentage View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals Wages Percentage View";
				Report_AddStep("testcase", " ACTUAL WAGEPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals Wages Percentage View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance Wages Percentage View";
				Report_AddStep("testcase", " VARIANCE WAGEPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Wages Percentage View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - OR Percentage View", priority = 5)
	public void ORPercentageView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned OR Percentage View";
				Report_AddStep("testcase", " PLANNED ORPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned OR Percentage View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals OR Percentage View";
				Report_AddStep("testcase", " ACTUAL ORPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals OR Percentage View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance OR Percentage View";
				Report_AddStep("testcase", " VARIANCE ORPERCENTAGE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance OR Percentage View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Items View", priority = 6)
	public void ItemsView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned Items View";
				Report_AddStep("testcase", " PLANNED ITEMS VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Items View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals Items View";
				Report_AddStep("testcase", " ACTUAL ITEMS VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals Items View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance Items View";
				Report_AddStep("testcase", " VARIANCE ITEMS VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Items View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Item Price View", priority = 7)
	public void ItemsPriceView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned Item Price View";
				Report_AddStep("testcase", " PLANNED ITEM PRICE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Item Price View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actual Item Price View";
				Report_AddStep("testcase", " ACTUAL ITEM PRICE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actual Item Price View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance Item Price View";
				Report_AddStep("testcase", " VARIANCE ITEM PRICE VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Item Price View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - Customer View", priority = 8)
	public void CustomersView() throws Exception {
		...
		for (int i = 0; i <= 2; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned Customer View";
				Report_AddStep("testcase", " PLANNED CUSTOMER VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned Customer View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals Customer View";
				Report_AddStep("testcase", " ACTUAL CUSTOMER VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals Customer View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance Customer View";
				Report_AddStep("testcase", " VARIANCE CUSTOMER VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance Customer View");
	...
	@Test(description = "Verify Group Total Value and Respective Group Value in Zone Screen - CPH View", priority = 9)
	public void CPHView() throws Exception {
		...
		for (int i = 0; i <= 1; i++) {
			...
			if (i == 0) {
				OptionToView = "Planned";
				String DailyPlanningStore = "GROUP to ZONE - Planned CPH View";
				Report_AddStep("testcase", " PLANNED CPH VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Planned CPH View");

			}
			if (i == 1) {
				OptionToView = "Actual";
				String DailyPlanningStore = "GROUP to ZONE - Actuals CPH View";
				Report_AddStep("testcase", " ACTUAL CPH VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Actuals CPH View");

			}
			if (i == 2) {
				OptionToView = "Variance";
				String DailyPlanningStore = "GROUP to ZONE - Variance CPH View";
				Report_AddStep("testcase", " VARIANCE CPH VIEW ", "", "", "");
				extentTest = report.startTest("GROUP to ZONE - Variance CPH View");
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningGroup.xml");
			data1.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningZone.xml");
