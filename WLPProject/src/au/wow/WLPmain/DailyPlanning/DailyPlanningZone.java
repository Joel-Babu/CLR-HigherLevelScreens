...
public class DailyPlanningZone extends TestBase {

	protected Logger log = LogManager.getLogger(DailyPlanningZone.class);
	TestStatus status;
	...
	@Test(description = "Daily Planning - Zone, Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.DPscreenToView, "Zone");
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("DailyPlanningZone"));*/
	...
	@Test(description = "Daily Planning - Zone, Hours View", priority = 2)
	...
	@Test(description = "Daily Planning - Zone, Wages View", priority = 3)
	...
	@Test(description = "Daily Planning - Zone, WagesPercentage View", priority = 4)
	...
	// OR
	@Test(description = "Daily Planning - Zone, OR View", priority = 5)
	public void ORPercentageView() throws Exception {

		extentTest = report.startTest("Daily Planning - Zone, Operatinoal Ratio View");
		pageWeeklyPlanningPO = new WeeklyPlanningStorePage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), WeeklyPlanningStorePage.class);
		pageDailyPlanningPO = new DailyPlanningPage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), DailyPlanningPage.class);
	...
	@Test(description = "Daily Planning - Zone, Items View", priority = 6)
	...
	@Test(description = "Daily Planning - Zone, Items Price View", priority = 7)
	...
	@Test(description = "Daily Planning - Zone, Customers View", priority = 8)
	...
	@Test(description = "Daily Planning - Zone, CPH View", priority = 9)
	...
	public void loadXMLFile() {
		try {
			...
			data.loadTestDataXML(System.getProperty("user.dir") + "\\TestData\\WLP\\DailyPlanningZone_ALL.xml");
