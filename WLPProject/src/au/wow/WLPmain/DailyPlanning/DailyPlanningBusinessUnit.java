...
public class DailyPlanningBusinessUnit extends TestBase {

	protected Logger log = LogManager.getLogger(DailyPlanningBusinessUnit.class);
	TestStatus status;
	...
	public DailyPlanningBusinessUnit() {
		super.log = log;
	}
	...
	@Test(description = "Daily Planning - Business Units, Sales View", priority = 1)
	public void SalesView() throws Exception {
		...
		pageWeeklyPlanningPO.selectPage(extentTest, objWeeklyPlanningStoreObjects.menuBar,
				objWeeklyPlanningStoreObjects.DPscreenToView, "Business Unit");
		/*pageWeeklyPlanningPO.verifyPageName(extentTest, objWeeklyPlanningStoreObjects.DataFrame,
				objWeeklyPlanningStoreObjects.pageName, getContext().getStringProperty("DailyPlanningBU"));*/
	...
	@Test(description = "Daily Planning - Business Units, Hours View", priority = 2)
	...
	@Test(description = "Daily Planning - Business Units, Wages View", priority = 3)
	...
	@Test(description = "Daily Planning - Business Units, WagesPercentage View", priority = 4)
	...
	@Test(description = "Daily Planning - Business Units, Operatinoal Ratio View", priority = 5)
	public void ORPercentageView() throws Exception {

		extentTest = report.startTest("Daily Planning - Business Units, Operatinoal Ratio View");
		pageWeeklyPlanningPO = new WeeklyPlanningStorePage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), WeeklyPlanningStorePage.class);
		pageDailyPlanningPO = new DailyPlanningPage().createPage(getDriver(), getContext(), log, status, data,
				getReport(), getReportLogger(), DailyPlanningPage.class);
	...
	@Test(description = "Daily Planning - Business Units, Items View", priority = 6)
	...
	@Test(description = "Daily Planning - Business Units, Items Price View", priority = 7)
	...
	@Test(description = "Daily Planning - Business Units, Customers View", priority = 8)
	...
	@Test(description = "Daily Planning - Business Units, CPH View", priority = 9)
